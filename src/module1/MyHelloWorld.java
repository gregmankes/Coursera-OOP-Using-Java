...
/** HelloWorld
  ...
  * Date: July 17, 2015
  * */
public class MyHelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// The next line zooms in and centers the map at 
	    // 40.35 (latitude) and -74.21 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(40.35f, -74.21f));
